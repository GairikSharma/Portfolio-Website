    ...
    <div className="App">
      ...
      <div className="nav">
        ...
        <div className="menu-items">
          <ul>
            <li onClick={()=>{scrollComponent(aboutref)}}>About</li>
            <li onClick={()=>{scrollComponent(educationref)}}>Education</li>
            <li onClick={()=>{scrollComponent(skillsref)}}>Skills</li>
            <li onClick={()=>{scrollComponent(projectsref)}}>Projects</li>
            <li onClick={()=>{scrollComponent(certificateref)}}>Certifications</li>
            <li onClick={()=>{scrollComponent(achivementref)}}>Achievement</li>
            <li onClick={()=>{scrollComponent(contactref)}}>Contact</li>
          </ul>
